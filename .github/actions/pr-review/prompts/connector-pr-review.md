...
context when needed. When provisioning files change, inspect the full PR-head file content
through `read-pr-file` if the diff does not contain enough context.
